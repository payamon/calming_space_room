...
try {
    ...
    if ($process_kind === 'process_purchase') {
...
<?php } ?>
        ...
        <menu>
            ...
            <form method="post" action="seach.php">
                <input type="text" name="kind" value="<?php print $kind; ?>">
    ...
    <?php } ?>
        ...
        <?php }else{ ?>
                        <figcaption>
                            ...
                            <input type="hidden" name="process_kind" value="process_purchase">
